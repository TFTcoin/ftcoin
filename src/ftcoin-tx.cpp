...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FTCoin Core ftcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ftcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ftcoin transaction") + "\n" +
              "  ftcoin-tx [options] -create [commands]   " + _("Create hex-encoded ftcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ftcoin transaction
