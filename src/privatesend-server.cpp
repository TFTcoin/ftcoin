...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all FTCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat FTCoin and make it unusable. To
