    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FTCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FTCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ftcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FTCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about FTCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FTCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FTCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FTCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ftcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FTCoin Core help message to get a list with possible FTCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FTCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FTCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("FTCoin Core"); // default title
