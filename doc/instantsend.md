...
This mechanism has been integrated into Bitcore-Node-FTCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tftcoin/insight-api-ftcoin#web-socket-api](https://github.com/tftcoin/insight-api-ftcoin#web-socket-api)
* API: [https://github.com/tftcoin/insight-api-ftcoin#instantsend-transactions](https://github.com/tftcoin/insight-api-ftcoin#instantsend-transactions)
...
By default, the FTCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FTCoin Core daemon:
