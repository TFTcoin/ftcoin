    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FTCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FTCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ftcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FTCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FTCOIN, 0.1 FTCOIN, 1 FTCOIN and 10 FTCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tftcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://tftcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FTCoin Core is shutting down...") + "<br /><br />" +
