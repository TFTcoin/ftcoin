...
#define BOOST_TEST_MODULE FTCoin Test Suite

#include "test_ftcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ftcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
