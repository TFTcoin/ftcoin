...
Only requiring some minor changes is ftcoin.cpp.
...
Changes to ftcoin.cpp
----------------------
ftcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
