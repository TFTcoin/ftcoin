...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FTCoinNetwork") type = FTCoinNetwork;
    if(strType == "FTCoinNetworkVariable") type = FTCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FTCoinNetwork) s = "FTCoinNetwork";
    if(type == FTCoinNetworkVariable) s = "FTCoinNetworkVariable";
