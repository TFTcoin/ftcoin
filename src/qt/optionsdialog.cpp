    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FTCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("FTCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("FTCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FTCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FTCOIN-traditional"), QVariant("trad"));
