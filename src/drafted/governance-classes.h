 ...
 *
 *   // network
 *   CFTCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ftcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFTCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FTCoinNetwork
// //   -- signature requirements : Key1(User)
// class CFTCoinNetworkVariable : public CGovernanceObject
// {
// private:
